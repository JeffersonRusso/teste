...
public class RealInterceptorChain implements TaskInterceptor.Chain {
    ...
    private final Map<String, DataValue> inputs;
    private final Task coreTask;

    public RealInterceptorChain(List<TaskInterceptor> interceptors, int index, Map<String, DataValue> inputs, Task coreTask) {
    ...
    @Override public Map<String, DataValue> inputs() { return inputs; }

    @Override
    public TaskResult proceed(Map<String, DataValue> nextInputs) {
