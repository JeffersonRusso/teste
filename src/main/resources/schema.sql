...
-- =================================================================================
-- 6. ASSOCIAÇÃO DE DECORADORES AOS NÓS
-- =================================================================================
...
-- =================================================================================
-- 9. CONTRATO DE DADOS (RG DOS DADOS)
-- =================================================================================
CREATE TABLE tb_data_contract (
    context_key VARCHAR(100) PRIMARY KEY,
    data_type VARCHAR(20) NOT NULL, -- STRING, NUMBER, BOOLEAN, OBJECT, DATE
    format_rule VARCHAR(255),       -- REGEX, ISO_DATE, CPF, EMAIL
    schema_definition TEXT,         -- JSON Schema para tipos OBJECT
    min_value DOUBLE,
    max_value DOUBLE,
